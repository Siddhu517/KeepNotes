...
export const addNotes = async (req, res) => {
  ...
  try {
    ...
    //console.log(user);
    res.status(200).json({ message: "add Note success", status: "ok" });
  } catch (err) {
...
export const updateNote = async (req, res) => {
  try {
    //console.log(req.body);
    const { id } = req.body;
    const { title, note } = req.body.updateData;
    ...
    res.status(200).json({ message: "Update Notes", status: "ok" });
  } catch (err) {
    console.log(err);
...
export const deleteNote = async (req, res) => {
  ...
  try {
    ...
    res.json({ message: "Deleted Note", status: "ok" });
  } catch (err) {
